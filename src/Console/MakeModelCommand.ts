...
class MakeModelCommand extends Command {
  protected signature = "make:model {model_class : class name of model} {-m : also create migration file}";
  ...
  public async handle() {
    ...
    if(this.option("m")){
      ...
      const generated  = await DB.getDb().migrate.make(`create_${TableName}_table`, {
